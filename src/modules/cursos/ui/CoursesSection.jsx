                      ...
                      <td style={styles.td}>
                        <div style={styles.actionRow} className="responsive-action-row">
                          ...
                          <button
                            ...
                            style={{ ...styles.smallButton, background: "#dc2626", color: "white", border: "none", display: "flex", alignItems: "center", justifyContent: "center", padding: "8px" }}
